...
class OrnsteinUhlenbeckProcess:
    ...
    def estimate_parameters(
        ...
        """
        # Convert prices to log-prices for stationarity
        ...
        # This gives us: dx = theta*(mu - x)*dt + sigma*sqrt(dt)*dW
        n = len(dx)
        ...
        logger.info(f"Estimated OU parameters: θ={params.theta:.4f}, μ={params.mu:.4f}, σ={params.sigma:.4f}")
